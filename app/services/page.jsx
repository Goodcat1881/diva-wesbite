...
const categories = [
  {
    ...
    services: [
      { name: 'Junior Stylist — Hair Cut',        price: 'From RM 35' },
      { name: 'Senior Stylist — Hair Cut',         price: 'From RM 55' },
      { name: 'Creative Director — Hair Cut',      price: 'From RM 80' },
      { name: 'Bambang Soteto — Hair Cut',         price: 'From RM 150' },
      { name: 'Fringe / Trim',                     price: 'From RM 15' },
    ],
  },
  {
    id: 'blowdry',
    ...
    services: [
      { name: 'Shampoo & Blow Dry',               price: 'From RM 35' },
      { name: 'Iron & Tong Style',                 price: 'From RM 15' },
      { name: 'Updo / Event Style',                price: 'From RM 80' },
      { name: 'Scalp Cleanse + Blow Dry',          price: 'From RM 55' },
    ],
  },
  {
    id: 'colouring',
    ...
    services: [
      { name: 'Gloss / Glazing',                   price: 'From RM 120' },
      { name: 'Root Touch-Up (single process)',     price: 'From RM 130' },
      { name: 'Full Head Colour (single process)',  price: 'From RM 180' },
      { name: 'Fashion Colour (vivid / fashion)',   price: 'From RM 250' },
      { name: 'Colour Correction',                  price: 'From RM 1,199' },
    ],
  ...
  },
  {
    ...
    services: [
      { name: 'Partial Highlights',                price: 'From RM 180' },
      { name: 'Full Head Highlights',              price: 'From RM 280' },
      { name: 'Balayage / Ombré',                  price: 'From RM 350' },
      { name: 'Money Piece',                        price: 'From RM 150' },
      { name: 'Toning',                             price: 'From RM 80' },
    ],
  },
  {
    id: 'chemical',
    ...
    services: [
      { name: 'Perm (digital / regular)',           price: 'From RM 250' },
      { name: 'Rebonding',                          price: 'From RM 350' },
      { name: 'Keratin Treatment',                  price: 'From RM 350' },
      { name: 'Relaxer / Straightening',            price: 'From RM 170' },
    ],
  ...
  },
  {
    ...
    services: [
      { name: 'Olaplex Treatment (full protocol)',  price: 'From RM 180' },
      { name: 'Nanomist Treatment',                 price: 'From RM 140' },
      { name: 'Nosu Treatment',                     price: 'From RM 150' },
      { name: 'Monzone Treatment',                  price: 'From RM 160' },
      { name: 'Deep Conditioning Mask',             price: 'From RM 89' },
    ],
  },
]
...
const addons = [
  { name: 'Gumash Add-on', price: 'RM 50' },
  { name: 'Olaplex Add-on (to any service)', price: 'RM 50' },
  { name: 'Bleaching Surcharge', price: 'Quoted at consultation' },
]
