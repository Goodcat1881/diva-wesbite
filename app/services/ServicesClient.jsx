    ...
    <main>
      ...
      <section className="page-hero">
        ...
        <p style={{ fontSize: '15px', lineHeight: 1.7, color: 'var(--muted)', maxWidth: '520px' }}>
          Full services menu for our muslimah hair salon branches in KL, Shah Alam, and Damansara. All prices are starting from — your stylist will confirm the final quote at consultation.
        </p>
      </section>
